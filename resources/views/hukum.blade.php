...
<body style="overflow-x: hidden">
    ...
    <nav class="navbar navbar-expand-sm fixed-top" style="background-color:beige; margin-top:2%" >
        <div class="container" style="margin-right: 20%;">
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="foto/IMG_20240924_113124.jpg.webp" class="d-block w-100" alt="First Slide" style="width: 20%; height: 800px; margin-top: 3%;">
                    <div class="carousel-caption d-none d-md-block">
                        <a href="/hukum1" style="color: inherit; text-decoration: none;">
                            <h2>Porles Bekasi buka kanal aduan terkait kasus jasad Kali Bekasi</h2>
                        </a>
                    </div>
                  </div>
