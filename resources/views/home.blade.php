        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <tr>
                        <img src="" alt="Gambar" class="img-fluid" style="width: 60%; height: 100%; margin-left: -40px;">                
                    </tr>                
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6  mt-5">
                    <tr> 
                        <img src="{{asset('/storage/foto/'.$item->foto)}}" alt="Gambar" class="img-fluid" style="width: 60%; height: 100%; margin-left: -40px;">                
                    </tr>                
                </div>
                <div class="col-sm-12 col-md-6" style="margin-top: 10%">
                    <td>
                        <h3 style="margin-left: -250px;">    
                            <a href="/isiberita/{{$item->id}}" id="text" style="color: inherit; text-decoration: none;" onclick="this.style.color='red';">
